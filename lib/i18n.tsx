...
const dictionaries: Record<Lang, Dictionary> = {
  uk: {
    pinned: "Закріплено", pin: "Закріпити", unpin: "Відкріпити", sortSets: "Сортувати набори", sortByDate: "За датою додавання", sortByProgress: "За прогресом", newestFirst: "Спочатку нові", oldestFirst: "Спочатку старі", highestFirst: "Від більшого до меншого", lowestFirst: "Від меншого до більшого",
    setTags: "Теги набору", setTagsHint: "Можна обрати кілька", "setTag.phrases": "Фрази", "setTag.nouns": "Іменники", "setTag.verbs": "Дієслова", "setTag.adjectives": "Прикметники", "setTag.adverbs": "Прислівники", "setTag.development": "Розробка", "setTag.other": "Інше",
  ...
  en: {
    pinned: "Pinned", pin: "Pin", unpin: "Unpin", sortSets: "Sort sets", sortByDate: "Date added", sortByProgress: "Learning progress", newestFirst: "Newest first", oldestFirst: "Oldest first", highestFirst: "Highest to lowest", lowestFirst: "Lowest to highest",
    setTags: "Set tags", setTagsHint: "Choose as many as you need", "setTag.phrases": "Phrases", "setTag.nouns": "Nouns", "setTag.verbs": "Verbs", "setTag.adjectives": "Adjectives", "setTag.adverbs": "Adverbs", "setTag.development": "Development", "setTag.other": "Other",
